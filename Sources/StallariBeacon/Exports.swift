...
//   - BeaconIdentityProvider    (DD-270 Phase B identity-injection protocol)
//   - FileInstallIDProvider     (default file-backed BeaconIdentityProvider conformance)
//   - InstallID                 (file-backed install-ID management — wraps `install_id` in beacon root)
